 ...
 */
final class Version20220205182343 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE care ADD price_string VARCHAR(255) NOT NULL, DROP price');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX names ON burial (last_name(40), first_name(40), middle_name(40))');
        $this->addSql('CREATE INDEX names_cemetery ON burial (last_name(40), first_name(40), middle_name(40), cemetery_name(40))');
        $this->addSql('ALTER TABLE care ADD price NUMERIC(20, 2) NOT NULL, DROP price_string');
    }
}
