 ...
 */
final class Version20210920150747 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cemetery_section ADD cemetery_id BIGINT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cemetery_section DROP cemetery_id');
    }
}
