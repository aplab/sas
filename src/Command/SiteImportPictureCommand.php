...
class SiteImportPictureCommand extends Command
{
    protected static $defaultName = 'site:import-picture';
...
//        }
    ...
    protected function loadData()
    {
        ...
        $sql = 'SELECT
                ...
                WHERE `container_id` = 2  -- and id=300
                ORDER BY `id`';
    ...
    private function clearAll(): void
    {
        ...
        $sql = 'TRUNCATE `v3.oytoy.ru`.`picture`';
        $mysqli->query($sql);
    }
    ...
    private function saveData(Result $data, SymfonyStyle $io)
    {
        ...
        while ($data_item) {
            ...
            $sql = 'INSERT INTO `v3.oytoy.ru`.picture
